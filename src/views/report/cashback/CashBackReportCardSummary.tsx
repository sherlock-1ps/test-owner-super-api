...
const CashBackReportCardSummary = (props: CardCashBackReportProps) => {
    ...
    id && (
      ...
      >
        <CardContent className='flex flex-col gap-2'>
          <Typography variant='h6'>Cashback #{title}</Typography>
          <div className='flex gap-2 justify-between'>
            <Typography variant='h6'>Total Cashback: </Typography>
...
export default CashBackReportCardSummary
