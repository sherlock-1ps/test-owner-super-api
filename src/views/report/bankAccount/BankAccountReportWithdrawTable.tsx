...
const BankAccountReportWithdrawTable = () => {
  // States
  ...
  const columns = useMemo<ColumnDef<InvoiceTypeWithAction, any>[]>(
    () => [
      ...
      columnHelper.accessor('total', {
        ...
        cell: ({ row }) => <Typography color={'error.main'}>{`$ ${row.original.total} บาท`}</Typography>
      }),
...
export default BankAccountReportWithdrawTable
