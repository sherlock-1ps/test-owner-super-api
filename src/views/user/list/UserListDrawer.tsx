...
const UserListDrawer = ({ open, handleClose }: Props) => {
  // States
  ...
  return (
    ...
    >
      <div className='flex items-center justify-between plb-5 pli-6'>
        <Typography variant='h5'>Filter Player</Typography>
      ...
      <div className='p-6'>
        <form onSubmit={handleSubmit} className='flex flex-col items-start gap-6'>
          ...
          <div>
            <Typography variant='h5'>Status Filter</Typography>
            <FormGroup>
              <FormControlLabel
                label='Avaliable'
          ...
          <div>
            <Typography variant='h5'>Tag Filter</Typography>
            <FormControlLabel
              control={<Checkbox defaultChecked name='color-primary' color='primary' />}
              label={
                <Chip
          ...
          <div>
            <Typography variant='h5'>Flag Filter</Typography>
            <FormControlLabel
              control={<Checkbox defaultChecked name='color-primary' color='primary' />}
              label={
                <Chip
