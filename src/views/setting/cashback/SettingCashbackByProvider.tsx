...
import SettingCashbackProviderTable from '@/views/react-table/SettingCashbackProviderTable'
...
const SettingCashbackByProvider = () => {
    ...
    <TabContext value={value}>
      ...
      <TabPanel value='1'>
        <Grid item xs={12} className='mt-4'>
          <SettingCashbackProviderTable keyProp='slot' />
        </Grid>
      </TabPanel>
      <TabPanel value='2'>
        <Grid item xs={12} className='mt-4'>
          <SettingCashbackProviderTable keyProp='casino' />
        </Grid>
      </TabPanel>
      <TabPanel value='3'>
        <Grid item xs={12} className='mt-4'>
          <SettingCashbackProviderTable keyProp='sport' />
        </Grid>
      </TabPanel>
      <TabPanel value='4'>
        <Grid item xs={12} className='mt-4'>
          <SettingCashbackProviderTable keyProp='lottery' />
        </Grid>
      </TabPanel>
    </TabContext>
  )
...
export default SettingCashbackByProvider
