        ...
        <CardContent>
          <Grid container spacing={4} alignItems='end'>
            ...
            <Grid item xs='auto' className=''>
              ...
              <DepositDrawer open={sendDrawerOpen} handleClose={() => setSendDrawerOpen(false)} />
            </Grid>
            ...
            <Grid item xs='auto' className=''>
              <Button
                ...
                onClick={() => {
                  showDialog({
                    id: 'dialogDepositAccount',
                    component: (
                      <ManageDepositDialog
                        id={'dialogDepositAccount'}
                        title={'Add Bank account for Deposit'}
                        onClick={() => {}}
                      />
                    )
                  })
