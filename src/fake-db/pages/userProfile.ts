...
export const db: DB = {
  users: {
    profile: {
      about: [
        { property: 'Full Name', value: 'Oneplaybet No1', icon: 'tabler-user' },
        { property: 'Status', value: 'active', icon: 'tabler-check' },
        { property: 'Role', value: 'OWN', icon: 'tabler-crown' },
        { property: 'Country', value: 'THAILAND', icon: 'tabler-flag' },
        { property: 'Language', value: 'THAI', icon: 'tabler-language' }
      ],
      contacts: [
        { property: 'Contact', value: '(123) 456-7890', icon: 'tabler-phone-call' },
        { property: 'Telgram', value: '@testoneplaybet', icon: 'tabler-brand-telegram' },
        { property: 'Email', value: 'oneplaybet@example.com', icon: 'tabler-mail' }
      ],
      teams: [
