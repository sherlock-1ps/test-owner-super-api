    ...
    >
      ...
      >
        ...
        <SubMenu label={dictionary['navigation'].report} icon={<i className='tabler-report-search' />}>
          <MenuItem href={`/${locale}/report/user`}>{dictionary['navigation'].userReport}</MenuItem>
          <MenuItem href={`/${locale}/report/bankaccount`}>{dictionary['navigation'].bankAccountReport}</MenuItem>
        ...
        {/* <MenuSection label={dictionary['navigation'].management}>
          <SubMenu label={dictionary['navigation'].userManagement} icon={<i className='tabler-user' />}>
            ...
            <MenuItem href={`/${locale}/user/tag`}>{dictionary['navigation'].tag}</MenuItem>
          </SubMenu>

          <SubMenu
            suffix={<CustomChip label='8' size='small' color='info' round='true' />}
            label={dictionary['navigation'].transaction}
            icon={<i className='tabler-database' />}
          >
            <MenuItem
              suffix={<CustomChip label='5' size='small' color='success' round='true' />}
              href={`/${locale}/transaction/deposit`}
            >
              {dictionary['navigation'].transactionDeposit}
            </MenuItem>
            <MenuItem
              suffix={<CustomChip label='3' size='small' color='error' round='true' />}
              href={`/${locale}/transaction/withdraw`}
            >
              {dictionary['navigation'].transactionWithdraw}
            </MenuItem>
            <MenuItem
              suffix={<CustomChip label='8' size='small' color='info' round='true' />}
              href={`/${locale}/transaction/operator`}
            >
              {dictionary['navigation'].transactionOperator}
            </MenuItem>
          </SubMenu>

          <SubMenu label={dictionary['navigation'].backAccount} icon={<i className='tabler-brand-cashapp' />}>
            <MenuItem href={`/${locale}/bankaccount/deposit`}>{dictionary['navigation'].depositAccount}</MenuItem>
            <MenuItem href={`/${locale}/bankaccount/withdraw`}>{dictionary['navigation'].withdrawAccount}</MenuItem>
            <MenuItem href={`/${locale}/bankaccount/rest`}>{dictionary['navigation'].restAccount}</MenuItem>
            <MenuItem href={`/${locale}/bankaccount/groupdeposit`}>{dictionary['navigation'].groupAccount}</MenuItem>
            <MenuItem href={`/${locale}/bankaccount/license`}>{dictionary['navigation'].autoLicense}</MenuItem>
            <MenuItem href={`/${locale}/bankaccount/transaction`}>
              {dictionary['navigation'].moveTransactionLog}
            </MenuItem>
          </SubMenu>

          <SubMenu label={dictionary['navigation'].promotion} icon={<i className='tabler-ticket' />}>
            <MenuItem href={`/${locale}/promotion/list`}>{dictionary['navigation'].promotionList}</MenuItem>
            <MenuItem href={`/${locale}/promotion/tracker`}>{dictionary['navigation'].promotionTracker}</MenuItem>
          </SubMenu>

          <MenuItem
            href={`/${locale}/advertisement`}
            icon={<i className='tabler-ad' />}
            exactMatch={false}
            activeUrl='/advertisement'
          >
            {dictionary['navigation'].advertisement}
          </MenuItem>
          <SubMenu label={dictionary['navigation'].bops} icon={<i className='tabler-shield-check-filled' />}>
            <MenuItem href={`/${locale}/bops/role`}>{dictionary['navigation'].rolesPermissions}</MenuItem>
            <MenuItem href={`/${locale}/bops/assistant`}>{dictionary['navigation'].assistantsMenu}</MenuItem>
          </SubMenu>

          <SubMenu label={dictionary['navigation'].settings} icon={<i className='tabler-settings' />}>
            <MenuItem href={`/${locale}/setting/website`}>{dictionary['navigation'].website}</MenuItem>
            <MenuItem href={`/${locale}/setting/affiliate`}>{dictionary['navigation'].affiliate}</MenuItem>
            <MenuItem href={`/${locale}/setting/cashback`}>{dictionary['navigation'].cashback}</MenuItem>
            <MenuItem href={`/${locale}/setting/minigame`}>{dictionary['navigation'].minigame}</MenuItem>
            <MenuItem href={`/${locale}/setting/currency`}>{dictionary['navigation'].currency}</MenuItem>
