...
const AccordionCashbackSetting = () => {
        ...
        <AccordionDetails>
          <Grid container className='flex flex-col gap-4'>
            <Grid item xs={12} sm className='flex flex-col gap-1'>
              <Typography>เวลาจ่ายค่าคืนยอดเสีย</Typography>
            ...
            <Grid item xs={12} sm className='flex flex-col gap-1'>
              <Typography>วันที่ให้ลูกค้ารับค่าคืนยอดเสีย</Typography>
              <Box>
                <AppReactDatepicker
                  selected={date}
            ...
            <Grid item xs={12} sm className='flex flex-col gap-1'>
              <Typography>ช่วงเวลาที่ให้ลูกค้ารับค่าคืนยอดเสีย</Typography>
              <TimeRangeSetting />
            </Grid>
          </Grid>
        </AccordionDetails>
...
export default AccordionCashbackSetting
