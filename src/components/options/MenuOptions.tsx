...
import { OptionMenuItemType, OptionsMenuType, OptionType } from '@/@core/components/option-menu/types'
...
const MenuOptions = (props: OptionsMenuType) => {
  // Props
                    ...
                    if (typeof option === 'string') {
                      ...
                      return (
                        <MenuItem
                          ...
                          onClick={e => {
                            if (option.onClick) option.onClick(e) // Trigger the custom onClick for the option
                            handleClose(e) // Close the menu after click
                          }}
                          className={classnames({
                            'text-error': option.text === 'Delete' // Apply 'text-red' class if option.text is 'Delete'
                          })}
                        >
